export type ITranslation = {
  ...
  'settings.pauseWhenBlur': string;
  'settings.pausePlayShortcut': string;
  'settings.imgMaxWidth': string;
  ...
  'marquee.name': string;
  'marquee.text': string;
  'marquee.backgroundColor': string;
  'marquee.textColor': string;
